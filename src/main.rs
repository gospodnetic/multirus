...
fn main() {
    ...
    let output_filename = String::from("test");
    ...
    bigtiff.write_image_with_compression::<colortype::RGB8, compression::Deflate>(dims.0, dims.1, compression::Deflate::default(), &img.as_bytes()).unwrap();
}
